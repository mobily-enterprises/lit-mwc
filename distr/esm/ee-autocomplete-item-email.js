...
class EeAutocompleteItemEmail extends ThemeableMixin('ee-autocomplete-item-email')(StyleableMixin(LitElement)) {
  ...
  _textValueGetter(short = false) {
    ...
    if (name && address) return `${name} <${address}>`;else if (name) return name;else if (address) return address;else return '';
  }
...
var eeAutocompleteItemEmail = {
  EeAutocompleteItemEmail: EeAutocompleteItemEmail
};
export { eeAutocompleteItemEmail as $eeAutocompleteItemEmail, EeAutocompleteItemEmail };