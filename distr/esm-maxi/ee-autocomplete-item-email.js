import {L as LitElement,c as css,h as html}from'./lit-element-97ae09cb.js';import {S as StyleableMixin}from'./StyleableMixin-6a125586.js';import {T as ThemeableMixin}from'./ThemeableMixin-af62e1ed.js';class EeAutocompleteItemEmail extends ThemeableMixin('ee-autocomplete-item-email')(StyleableMixin(LitElement)) {
  static get styles () {
    return [
      super.styles || [],
      css`
...
customElements.define('ee-autocomplete-item-email-view', EeAutocompleteItemEmailView);export{EeAutocompleteItemEmail};